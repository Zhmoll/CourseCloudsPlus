...
window.onload = function () {
    ...
    $.get("../api/courses/" + courseid + "/askforleave", function (data) {
        ...
        for (i = 0; i < data.body.length; i++) {
            ...
            //         }
            //     }
            //     $("#myleave").append('<li class="ui-border-t"><p><span>课程号：</span><span class="date">' + title + '</span></p> <p><span>课程名：</span><span class="date">' + teacher + '</span></p> <p><span>上课时间：</span><span class="date">' + date + '</span></p> <p><span>原因：</span><span class="date">' + content + '</span></p><p><span style="color: red">已允许</span></p></li>')
