...
function week() {
    ...
    $.get("http://courseclouds.zhmoll.com/api/term/currentWeek", function(data_week){
        alert("data_week "+data_week.term);
    });
    //服务器需要给出的数据
    $.get("http://courseclouds.zhmoll.com/api/profile/coursetimes",function(data_course){
        //alert(data_course);
    });
    //alert(typeof data_course.body)
    var getcourse = data_course.body;//课程信息数组
    var weeknum = data_week.body.week;//当前周数
